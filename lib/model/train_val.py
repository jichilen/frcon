...
class SolverWrapper(object):
  ...
  def construct_graph(self, sess):
    with sess.graph.as_default():
      ...
      layers = self.net.create_architecture('TRAIN', num_classes, tag='default',
  ...
  def train_model(self, sess, max_iters):
    ...
    self.data_layer = RoIDataLayer(self.roidb, num_classes)
    self.data_layer_val = RoIDataLayer(self.valroidb, num_classes, random=True)
